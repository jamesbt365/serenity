...
impl Http {
    ...
    pub async fn ban_user(
        ...
        self.wind(204, Request {
            ...
            params: &[("delete_message_seconds", delete_message_seconds.to_string())],
        })
        .await
    }
    ...
    pub async fn get_thread_channel_member(
        ...
        self.fire(Request {
            ...
            params: &[("with_member", with_member.to_string())],
        })
        .await
    }
    ...
    pub async fn get_global_commands_with_localizations(&self) -> Result<Vec<Command>> {
        self.fire(Request {
            ...
            params: &[("with_localizations", String::from("true"))],
        })
        .await
    }
    ...
    pub async fn get_guild_with_counts(&self, guild_id: GuildId) -> Result<PartialGuild> {
        self.fire(Request {
            ...
            params: &[("with_counts", String::from("true"))],
        })
        .await
    }
    ...
    pub async fn get_scheduled_event(
        ...
        self.fire(Request {
            ...
            params: &[("with_user_count", with_user_count.to_string())],
        })
        .await
    }
